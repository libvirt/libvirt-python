...
functions_failed = []  # type: List[str]
lxc_functions_failed = []  # type: List[str]
qemu_functions_failed = []  # type: List[str]
functions_skipped = [
    "virConnectListDomains",
]
lxc_functions_skipped = []  # type: List[str]
qemu_functions_skipped = []  # type: List[str]
            ...
            for info in sorted(flist, key=functionSortKey):
                ...
                if r_type != "void":
                    if r_type in classes_type:
                        ...
                        #
                        classes.write("        __tmp = ")
                        classes.write(classes_type[r_type][1] % ("ret"))
                        classes.write("\n")
